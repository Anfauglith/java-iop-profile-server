package version_mati_01.structure.processors.internal.primary;
 ...
 */
public class PrimaryProcessorWriteManager implements WriteManager<BaseSession> {

    /** A logger for this class */
    private final static Logger LOG = LoggerFactory.getLogger(PrimaryProcessorWriteManager.class);

    private AbstractProcessor<BaseSession> processor;

    public PrimaryProcessorWriteManager() {
    }
        ...
        try {
            ...
            do {
                ...
                if (message instanceof ByteBuffer) {
                    ...
                    // si se escribió puedo cerrar la session
